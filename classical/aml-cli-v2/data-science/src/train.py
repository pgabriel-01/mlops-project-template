...
def main(args):
    ...
    pip_reqs = [
        ...
        "numpy==2.2.6",
        "cloudpickle==3.1.1",
        "pyarrow==18.1.0",  # Include pyarrow to prevent MLflow from auto-detecting incompatible version
        "scipy==1.15.1",  # Include scipy to prevent pip from trying to build older versions from source
    ]
