...
PARAMETER_MAP = {
    ...
    "enable_private_aks_inference": "enablePrivateAksInference",
    ...
    "online_namespace": "onlineNamespace",
    "online_service_account": "onlineServiceAccountName",
    "online_node_pool_name": "onlineNodePoolName",
    "online_node_vm_size": "onlineNodeVmSize",
    "online_node_min_count": "onlineNodeMinCount",
    "online_node_max_count": "onlineNodeMaxCount",
    "online_node_max_pods": "onlineNodeMaxPods",
    "online_instance_type": "onlineInstanceTypeName",
    "online_cpu_request": "onlineCpuRequest",
    "online_cpu_limit": "onlineCpuLimit",
    "online_memory_request": "onlineMemoryRequest",
    "online_memory_limit": "onlineMemoryLimit",
    "aml_kubernetes_extension_name": "amlKubernetesExtensionName",
    "aml_kubernetes_extension_release_train": "amlKubernetesExtensionReleaseTrain",
    "aml_kubernetes_extension_ssl_cname": "amlKubernetesExtensionSslCname",
